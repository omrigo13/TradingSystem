...
public class SystemAliveWithoutExternalServicesTest {
    ...
    private PaymentSystemFake paymentSystem;
    private DeliverySystemFake deliverySystem;
    ...
    void setUp() throws InvalidActionException {
        ...
        paymentSystem = new PaymentSystemFake();
        deliverySystem = new DeliverySystemFake();
    ...
    public synchronized void test() throws InvalidActionException {
        String conn = tradingSystemService.connect();

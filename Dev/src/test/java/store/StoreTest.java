...
//    }
    ...
    void searchItemByName() throws Exception{
        ...
        assertThrows(ItemNotFoundException.class, () -> store.searchItemByName("carrot"));
    ...
    void searchItemByCategory() throws Exception{
        store.addItem("tomato", 20, "vegetables", "red", 5);
        store.addItem("cucumber", 15, "vegetables", "green", 10);
        assertThrows(ItemNotFoundException.class, () -> store.searchItemByCategory("camera"));
    ...
    void searchItemByKeyWord() throws Exception{
        store.addItem("tomato", 20, "vegetables", "red", 5);
        store.addItem("cucumber", 15, "vegetables", "green", 10);
        assertThrows(ItemNotFoundException.class, () -> store.searchItemByKeyWord("blue"));
    ...
    void searchItem() throws Exception{
        ...
        store.addItem("cucumber", 15, "vegetables", "green", 10);
        store.addItem("tomato", 20, "vegetables", "blue", 5);
        assertThrows(ItemNotFoundException.class, () -> store.searchItem("tomato", "fruits","orange"));
    ...
    void filterByPrice() throws Exception{
        store.addItem("tomato", 20, "vegetables", "red", 5);
        store.addItem("cucumber", 15, "vegetables", "green", 10);
        assertThrows(ItemNotFoundException.class, () -> store.filterByPrice(30, 100));
        store.addItem("tomato", 20, "vegetables", "blue", 5);
    ...
    void filterByRating() throws Exception{
        ...
        assertThrows(ItemNotFoundException.class, () -> store.filterByRating(4));
    ...
    void changeQuantity() throws Exception{
        ...
        assertThrows(WrongAmountException.class, () -> store.changeQuantity("tomato", "vegetables","red", -1));
    ...
    void decreaseByQuantity() throws Exception{
        ...
        //checks that the quantity must be 0 or greater
        assertThrows(WrongAmountException.class, () -> store.decreaseByQuantity("carrot", "vegetables","orange",5));
    ...
    void removeItem() throws Exception{
        ...
        assertThrows(ItemNotFoundException.class, () -> store.removeItem("tomato", "vegetables","orange"));

        store.removeItem("carrot", "vegetables","orange");
        assertEquals(store.getItems().size(), 1);
        assertThrows(ItemNotFoundException.class, () -> store.removeItem("carrot", "vegetables","orange"));

...
public class OwnerPermissionDAO {
    ...
    public static OwnerPermission getById(int id) throws Exception {
    ...
    public static void add(OwnerPermission ownerPermission) throws Exception {
        EntityManager em = ENTITY_MANAGER_FACTORY.createEntityManager();
    ...
    public static List<OwnerPermission> getAll() throws Exception {
        EntityManager em = ENTITY_MANAGER_FACTORY.createEntityManager();
